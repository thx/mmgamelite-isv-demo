...
- @ali/pixi-miniprogram-engine-v6
...
#### 2.安装@ali/pixi-miniprogram-engine-v6依赖，以及pixi的type描述依赖
...
```javascript
npm install @ali/pixi-miniprogram-engine-v6--by=yarn
...
```javascript
import { Texture, Sprite, Text } from "@ali/pixi-miniprogram-engine-v6";
Page({
  // 供pixi渲染的canvas
  canvas: null,
  context: null,
